...
// Check for debug/sim mode via query param or environment
const getDefaultRedirect = () => {
	const params = new URLSearchParams(window.location.search);
	if (params.get("mode") === "sim" || params.get("debug") === "true") {
		return "/sim/menu";
	}
	// In development, default to simulator; in production, default to fullscreen
